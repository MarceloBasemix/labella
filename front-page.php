...
<?php /* HACK Post Categoria Marcas */ ?>
<section id="categories">
		<div class="container_12" style="position:relative">
				
				<ul style="width:960px; display:block; float:left;margin-left: 15px;">
					
				<?php
				
				// Mostra os Posts relacionados dos Produtos
				
				$loop = new WP_Query( array('post_type' => 'post', 'posts_per_page' => 6, 'category_name' => 'marcas-2' ) );				
				...
				?>
									<li style="list-style:none;">
										<div class="cat_marcas">
									
										  <!-- <a href="<?php the_permalink(); ?>"><?php  the_post_thumbnail(); //get_post_thumbnail_id($loop->ID); ?></a>-->
										  <?php the_content(); ?>
									</li>
...
<?php if( is_sidebar_active('Home Specials') ) : ?>
	<div class="grid_12">
		<?php /*echo '<div class="title border" style="margin-bottom:20px">
					<h2 class="category-title">Destaques</h2>
					</div>';*/
		?>
		<?php dynamic_sidebar( 'Home Specials' ); ?>
		<?php echo NggRandom(2); ?>		
