...
<?php /** My variation stuff */ ?>
      ...
      <div id="variation-colours">
        ...
        <?php if (wpsc_have_variation_groups()) { ?>
        <?php $wpsc_variations_in_stock = false;?>
        ...
        <style>
          ...
          while (wpsc_have_variation_groups()) : wpsc_the_variation_group(); ?>
            ...
            <?php while (wpsc_have_variations()) : wpsc_the_variation(); ?>
              <?php
              //echo "<br/>ID: ";echo wpsc_the_variation_id();
              ...
              //echo "<pre>";print_r($attached_images);echo "</pre>";
              
              
              /* HACK:FORÇA TRAZER AS IMAGENS DE VARIAÇÕES */
              ...
              <?php if(wpsc_the_variation_out_of_stock() ==""){
					$wpsc_variations_in_stock = true; ?>
			<div id="agrupado">
