		...
		<div class="container_12">
			<div id="cadastre_se">
				...
				<?php if (!is_user_logged_in()){ ?>
						<span class="cadastro"><a href="/clientes/fainearts/labella/registrar-se/" style="text-decoration: none;color:#FFFFFF;">Olá, Vistante. Aproveite e Cadastra-se, clicando aqui</a>.</span>
				<?php }else{ ?>
					<?php  $nonce= wp_nonce_field(); ?>

							<?php /* $nonce= wp_create_nonce( 'my-nonce' ); ?>
							<a href='myplugin.php?_wpnonce=<?php echo $nonce; ?>'> Sair2</a>
						...
						<span class="cadastro">
							<a href="http://www.basemix.com.br/clientes/fainearts/labella/login/" style="text-decoration: none;color:#FFFFFF;">Meus Dados</a> | <a href="/clientes/fainearts/labella/products-page/your-account/" style="text-decoration: none;color:#FFFFFF;">Histórico de pedidos </a> | <a href="http://www.basemix.com.br/clientes/fainearts/labella/sair/" style="text-decoration: none;color:#FFFFFF;">Sair</a>
							</span>
				<?php } ?>
			</div>
