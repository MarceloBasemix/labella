	...
	if ( count( $special_products ) > 0 ) {
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); 
				...
				<?php if(wpsc_have_variation_groups()): 
						...
						// HACK: Pega o valor principal do produto
				...
				<div class="price-box">
					...
					<span class="oldprice" id="old_product_price_<?php echo wpsc_the_product_id(); ?>" style="margin-left: 70px !important;font-size: 12px !important;"><?php echo wpsc_product_normal_price(); ?></span><br/>
					<?php endif; ?>
